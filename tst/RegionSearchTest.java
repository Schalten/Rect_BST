...
public class RegionSearchTest extends TestCase{
...
//				+ "| here. "
	...
	private String[] getInput() {
		...
		return new String[]{
				"insert r1 0 0 3 4",
				"insert r2 5 0 5 3",
				"insert r3 1000 4 20 300",
//				"regionsearch 4 6 0 10",
				"regionsearch 2 2 4 3",
				"regionsearch -3 2 7 5",
				"regionsearch 1019 5 75 20",
				"regionsearch 0 20 4 6"
		};
	}
	...
	private String[][] getOutput() {
		// TODO Auto-generated method stub
		return new String[][]{
			{"Rectangle accepted:(r1, 0, 0, 3, 4)"},
			{"Rectangle accepted:(r2, 5, 0, 5, 3)"},
			{"Rectangle accepted:(r3, 1000, 4, 20, 300)"},
//			{"rejected|invalid region"},
			{"Rectangles intersecting region (2, 2, 4, 3):",
				"(r1, 0, 0, 3, 4)","(r2, 5, 0, 5, 3)"},
			{"Rectangles intersecting region (-3, 2, 7, 5):",
					"(r1, 0, 0, 3, 4)"},
			{"Rectangles intersecting region (1019, 5, 75, 20):",
						"(r3, 1000, 4, 20, 300)"},
			{"Rectangles intersecting region (0, 20, 4, 6):"}
		};
	}

	private String[] getParams() {
		// TODO Auto-generated method stub
		return new String[]{"RegionSearchTest.txt"};
	}
...
//						if(visited[j])
//							throw new Exception("You forgot to report the rectangle named"
//									+ " |" + nodeInfo[j].replaceFirst("\\s.*$", "") + "|");

...
public class BigInsertTest extends TestCase{
...
//				+ "| here. "
	...
	private String[] getInput(){
		return new String[]{"dump",
				...
				"insert ThisIsValidToo 24 23 4 1",
	...
	private String[][] getOutput(){
		return new String[][]{
			...
			{"Rectangle accepted:(ThisIsValidToo, 24, 23, 4, 1)"},
			{"Rectangle accepted:(rand23, 521, 752, 335, 181)"},
			{"Rectangle rejected:(reject2, 545, 24, 21, 3333)"},
			{"BST dump:"
				, "Node has depth 4, Value (ThisIsValidToo, 24, 23, 4, 1)"
				, "Node has depth 3, Value (XYZ, 423, 643, 23, 300)"
				, "Node has depth 4, Value (rand, 81, 818, 15, 12)"
				, "Node has depth 6, Value (rand23, 521, 752, 335, 181)"
				, "Node has depth 5, Value (rand37, 802, 446, 171, 2)"
				, "Node has depth 2, Value (rec1, 50, 50, 100, 25)"
				, "Node has depth 1, Value (rec15, 50, 50, 100, 25)"
				, "Node has depth 2, Value (rect9, 7, 71, 34, 51) OR "
					+ "Node has depth 3, Value (rect9, 73, 4, 12, 45)"
				, "Node has depth 2, Value (rect9, 7, 71, 34, 51) OR "
					+ "Node has depth 3, Value (rect9, 73, 4, 12, 45)"
				, "Node has depth 0, Value (topleftCorner, 0, 0, 7, 6)"
				, "Node has depth 2, Value (val9, 24, 23, 4, 1)"
				, "Node has depth 3, Value (validOne, 24, 23, 4, 1)"
	...
	private String[] getParams(){
		return new String[]{"BigInsertTest.txt"};
	}

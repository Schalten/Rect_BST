...
public class RemovalTest extends TestCase{
...
//				+ "| here. "
	...
	private String[] getInput(){
		return new String[]{
				"insert name1 1 0 2 4",
				"insert name2 1 0 2 4",
				"insert name1 4 6 2 2",
				"insert name3 1 2 1023 4", 
				"insert name3 0 0 12 4",
				"remove name1",
				"remove 1 0 2 4",
				"remove 0 0 12 4",
				"remove -1 3 23 454",
	...
	private String[][] getOutput(){
		return new String[][]{
			{"Rectangle accepted:(name1, 1, 0, 2, 4)"},
			{"Rectangle accepted:(name2, 1, 0, 2, 4)"},
			{"Rectangle accepted:(name1, 4, 6, 2, 2)"},
			{"Rectangle accepted:(name3, 1, 2, 1023, 4)"},
			{"Rectangle accepted:(name3, 0, 0, 12, 4)"},
			{},{},{},{"Rectangle rejected:(-1, 3, 23, 454)"},
			{"Rectangle rejected:(1, 2, 3, 4)"},
			{"BST dump:"
				, "Node has depth 0, Value (name1, 1, 0, 2, 4) OR "
						+ "Node has depth 0, Value (name1, 4, 6, 2, 2) OR "
						+ "Node has depth 1, Value (name1, 4, 6, 2, 2) OR "
						+ "Node has depth 0, Value (name2, 1, 0, 2, 4)"
				, "Node has depth 0	, Value (name3, 0, 0, 12, 4) OR "
						+ "Node has depth 1	, Value (name3, 0, 0, 12, 4)"
				, "BST size is: 2"}
		};
	}
	...
	private String[] getParams(){
		return new String[]{"RemovalTest.txt"};
	}

...
//				+ "| here. "
	...
	private String[][] getOutput(){
		return new String[][]{
			{"Rectangle accepted:(a, 1, 2, 3, 4)"},
			{"Rectangle accepted:(b, 4, 6, 212, 5)"},
			{"Rectangle accepted:(c, 32, 6, 2, 46)"},
			{}, {}, {}, 
	...
	private String[] getParams(){
		return new String[]{"RemoveAllTest.txt"};
	}
	
	/* (non-Javadoc)
	 * @see tests.ReferenceData#containsNodeInfo(java.lang.String, java.lang.String[])
	 */
